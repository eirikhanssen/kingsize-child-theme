...
<head>
	...
	.container { background-image:  url(<?php echo get_stylesheet_directory_uri(); ?>/images/opacity/90/content_back.png); }
	</style>
	<?php } elseif( $data['wm_enable_opacity']  == "0.8 Opacity") { ?>
	<style>
	/*<!--- .8 --->*/
	.sub-menu { opacity: 0.8; }
	.container { background-image:  url(<?php echo get_stylesheet_directory_uri(); ?>/images/opacity/80/content_back.png); }
	</style>
	<?php } elseif( $data['wm_enable_opacity']  == "0.7 Opacity") { ?>
	<style>
	/*<!--- .7 --->*/
	.sub-menu { opacity: 0.7; }
	.container { background-image:  url(<?php echo get_stylesheet_directory_uri(); ?>/images/opacity/70/content_back.png); }
	</style>
	<?php } elseif( $data['wm_enable_opacity']  == "Default") { ?>
	<style>
	/*<!--- Default --->*/
	.sub-menu { opacity: 1; }
	.container { background-image:  url(<?php echo get_stylesheet_directory_uri(); ?>/images/content_back.png); }
	</style>
	<?php } ?>
...
?>
	...
	if( $data['wm_enable_opacity'] == "0.9 Opacity") { 
		...
		$img_hide_menu_back = get_stylesheet_directory_uri()."/images/opacity/90/hide_menu_back.png";
		$img_menu_hide_arrow_top = get_template_directory_uri()."/images/menu_hide_arrow_top.png";
		$menu_back = get_stylesheet_directory_uri()."/images/opacity/90/menu_back.png";

	 } elseif( $data['wm_enable_opacity']  == "0.8 Opacity") { 

		$img_hide_menu_back = get_stylesheet_directory_uri()."/images/opacity/80/hide_menu_back.png";
		$img_menu_hide_arrow_top = get_template_directory_uri()."/images/menu_hide_arrow_top.png";
		$menu_back = get_stylesheet_directory_uri()."/images/opacity/80/menu_back.png";
	 
	 } elseif( $data['wm_enable_opacity']  == "0.7 Opacity") { 
		
		$img_hide_menu_back = get_stylesheet_directory_uri()."/images/opacity/70/hide_menu_back.png";
		$img_menu_hide_arrow_top = get_template_directory_uri()."/images/menu_hide_arrow_top.png";
		$menu_back = get_stylesheet_directory_uri()."/images/opacity/70/menu_back.png";
	  
	  } elseif( $data['wm_enable_opacity']  == "Default") { 
		
		$img_hide_menu_back = get_stylesheet_directory_uri()."/images/hide_menu_back.png";
		$img_menu_hide_arrow_top = get_template_directory_uri()."/images/menu_hide_arrow_top.png";
		$menu_back = get_stylesheet_directory_uri()."/images/menu_back.png";
	  }
	?>
	<!-- End of New Opacity/Tranparency Options -->
    ...
    <div class="row">
	    <div id="navContainer" class="front hide-for-small">
			...
			if( $data['wm_enable_opacity'] == "0.9 Opacity") { 
				...
				$img_hide_menu_back = get_stylesheet_directory_uri()."/images/opacity/90/hide_menu_back.png";
				$img_menu_hide_arrow_top = get_stylesheet_directory_uri()."/images/menu_hide_arrow_top.png";
